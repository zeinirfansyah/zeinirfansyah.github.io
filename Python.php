...
<body>
  ...
  <!-- End Header -->
    ...
    <div class="content-video">
        <div class="tab">
            <h1 style="font-size: 36px;">Python Tutorial</h1>
            <h2>Mentor : Zein Irfansyah</h2>
            <hr>
            <button class="tablinks" onclick="openCity(event, 'Conten1')" id="defaultOpen">Introduction</button>
            <button class="tablinks" onclick="openCity(event, 'Conten2')">Installasi Python dan VS Code</button>
            <button class="tablinks" onclick="openCity(event, 'Conten3')">Conten3</button>
        ...
        <div id="Conten1" class="tabcontent">
            <iframe width="480px" height="270px" src="https://www.youtube.com/embed/wy9s2coZvNc" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </iframe>
            <hr style="margin-top: 20px;">
            <h1 style="font-size: 30px; margin: 10px 0px;">Episode 0 - Introduction</h1>
        ...
        <div id="Conten2" class="tabcontent">
            <iframe width="480px" height="270px" src="https://www.youtube.com/embed/Dv5Cb5-ucDw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <hr style="margin-top: 20px;">
            <h1 style="font-size: 30px; margin: 10px 0px;">Episode 0 - Introduction</h1>
            <p style="font-size: 12px;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit dolores quos
                esse repellendus maxime. Magni doloribus soluta deleniti tempora saepe nihil totam quisquam, ex
