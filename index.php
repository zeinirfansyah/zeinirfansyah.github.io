...
<body style="background-image:black; font-size: 20px" >
  <!-- Header -->
  <section id="header">
    <div class="header container">
      <div class="nav-bar">
        ...
        <div class="nav-list">
          ...
          <ul>
            <li><a href="login.php" data-after="Skill">Masuk</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section id="zein">
    <div class="zein container">
      <div>
        ...
        <h1 style="color:#FFFFFF; font-size: 20px">Platform belajar coding gratis karya anak bangsa!</h1>
        <a href="login.php" type="button" class="cta">Start learning</a>
      </div>
    </div>
  </section>
  <!-- End zein Section  -->
   ...
   <section id="about">
    <div class="about container">
      <div class="col-left">
        <div class="about-img">
          <img src="./img/Zein.jpg" alt="img">
        </div>
      </div>
      <div class="col-right">
        <h1 class="section-title"><span>Founder</span></h1>
        <h2>Zein Irfansyah - Artificial Intelligence Developer</h2>
        <p>“Lulusan S1 dengan spesialisasi di Teknik Informatika. Memiliki pengalaman dalam mengembangkan dan mengimplementasikan Artificial Intelligence melalui kesempatan magang di dua perusahaan multinasional.”</p>
        <a href="https://www.linkedin.com/in/zein-irfansyah-2421081a5" target="_blank" class="cta">Download Resume</a>
      </div>
    </div>
  </section>
  <!-- End About Section -->
    ...
    <div class="contact container">
      ...
      <div class="contact-items">
        ...
        <div class="contact-item">
          ...
          <div class="contact-info">
            <h1>Alamat</h1>
            <h2>Desa Mekarwangi, Kecamatan Cisayong, Kabupaten Tasikmalaya, Jawa Barat, Indonesia</h2>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="footer">
    <div class="footer container">
      ...
      <h2>Belajar coding online gratis!</h2>
