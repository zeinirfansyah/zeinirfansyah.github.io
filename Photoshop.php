        ...
        <table border="1px" celpadding="0px">
            <tr>
                ...
                <td style="width: 720px;">
                    ...
                    <iframe width="480px" height="270px" src="https://www.youtube.com/embed/t0JWHiLFzQo?list=PLJ8KMkXR105azYiQvmCvEepwpdswOJMpH" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        
                        <hr style="margin-top: 20px;">
                        <h1 style="font-size: 30px; margin: 10px 0px;">Episode 01 - 3D Logo Design</h1>
                        <p style="font-size: 15px;">Pada episode kali ini, kita akan mempelajari dasar-dasar desain logo dalam bentuk 
                        tiga dimensi dengan photoshop. Pastikan anda mengikuti video dengan baik.</p>
                    </div>
            
                    
            
                    <div id="Conten2" class="tabcontent">
                    <iframe width="480px" height="270px" src="https://www.youtube.com/embed/aCaTf0_hZec?list=PLJ8KMkXR105azYiQvmCvEepwpdswOJMpH" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

                        <hr style="margin-top: 20px;">
                        <h1 style="font-size: 30px; margin: 10px 0px;">Episode 02 - Abstract Wallpaper Design</h1>
                        <p style="font-size: 15px;">Pada episode kali ini, kita akan mempelajari dasar-dasar pembuatan wallpaper
                        abstract estetik dengan photoshop. Pastikan anda mengikuti video dengan baik.</p>
                    </div>
            
                    <div id="Conten3" class="tabcontent">
                    <iframe width="480px" height="270px" src="https://www.youtube.com/embed/7fYaCa3bOqU?list=PLJ8KMkXR105azYiQvmCvEepwpdswOJMpH" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

                        <hr style="margin-top: 20px;">
                        <h1 style="font-size: 30px; margin: 10px 0px;">Episode 03 - Info Graphic Design</h1>
                        <p style="font-size: 15px;">Pada episode kali ini, kita akan mempelajari Desain untuk suatu informasi secara indah dan estetik
                         dengan photoshop. Pastikan anda mengikuti video dengan baik.</p>
                    </div>
